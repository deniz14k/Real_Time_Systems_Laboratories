...
public class Main {
    public static void main(String[] args) throws BrokenBarrierException, InterruptedException {
        ...
        while(true) {
            new lab6.src.App1.ExecutionThread(barrier, lock1, lock2, times1).start();
            new lab6.src.App1.ExecutionThread(barrier, lock2, lock1, times2).start();
